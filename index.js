...
const client = new pg.Client({
  connectionString: process.env.DATABASE_URL || "postgres://localhost/the_acme_hr_db",
});
...
const init = async () => {
  ...
  let SQL = `
    ...
    INSERT INTO employees(name, department_id) VALUES('Vincent', 1);
    INSERT INTO employees(name, department_id) VALUES('Torie', 2);
    INSERT INTO employees(name, department_id) VALUES('Kemp', 3);
`;
